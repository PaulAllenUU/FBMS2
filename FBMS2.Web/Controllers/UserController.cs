...
namespace FBMS2.Web.Controllers
{
    public class UserController : BaseController
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Register([Bind("FirstName,SecondName,Email,Password,PasswordConfirm,Role")] UserRegisterViewModel m)       
        {
            ...
            var user = _svc.AddUser(m.FirstName, m.SecondName, m.Email,m.Password, m.Role);
        ...
        public IActionResult UpdateProfile()
        {
           // use BaseClass helper method to retrieve Id of signed in user 
            var user = _svc.GetUserById(User.GetSignedInUserId());
        ...
        {
            var user = _svc.GetUserById(m.Id);
